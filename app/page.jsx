        ...
        {regions.map((r, index) => {
          ...
          return (
            <path
              key={`${r.id}-${index}`}
              d={r.d}
              fill={isActive ? `${r.color}cc` : `${r.color}70`}
...
export default function HomePage(){
  ...
  return (
    <main className="mobile-app">
      ...
      <section className="hero-card blue-hero">
      ...
      <section className="map-card">
        <div className="card-head">
          <div><h2>מפת השרירים</h2><p>לחץ על אזור שריר צבעוני כדי לראות תרגילים מתאימים.</p></div>
